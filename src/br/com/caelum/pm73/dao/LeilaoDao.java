...
public class LeilaoDao {
	...
	public double getValorInicialMedioDoUsuario(Usuario usuario) {
		return (Double) session.createQuery("select avg(lance.leilao.valorInicial) from nunes as (select distinct lance.leilao from Lance lance where lance.usuario = :usuario)")
